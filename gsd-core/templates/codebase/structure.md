...
- Usage: Reference from command with `@D:/projects/vietnga/BoNaoTriThuc/company-wiki/gsd-core/workflows/{name}.md`
...
**gsd-core/**
- Purpose: Resources installed to D:/projects/vietnga/BoNaoTriThuc/company-wiki/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to D:/projects/vietnga/BoNaoTriThuc/company-wiki/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
