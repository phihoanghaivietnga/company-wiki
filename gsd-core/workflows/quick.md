...
- .clinerules or ./.cline/.clinerules (if exists — project-specific guidelines)
...
- .clinerules or ./.cline/.clinerules (if exists — follow project-specific guidelines)
...
- .planning/STATE.md (Project state)
- .clinerules or ./.cline/.clinerules (Project instructions, if exists)
