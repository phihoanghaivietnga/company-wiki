...
ones). Reference: @D:/projects/vietnga/BoNaoTriThuc/company-wiki/gsd-core/references/edge-probe.md.
...
# — NOT the consuming project's git root — falling back to git toplevel / D:/projects/vietnga/BoNaoTriThuc/company-wiki.
...
EDGE_PROBE_JS=$(for _c in \
  ...
  "$_GSD_RT/.cline/bin/lib/edge-probe.cjs" \
  "D:/projects/vietnga/BoNaoTriThuc/company-wiki/gsd-core/bin/lib/edge-probe.cjs" \
  "D:/projects/vietnga/BoNaoTriThuc/company-wiki/bin/lib/edge-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
...
requirement list). Reference: @D:/projects/vietnga/BoNaoTriThuc/company-wiki/gsd-core/references/prohibition-probe.md — the
...
Use the SPEC.md template from @D:/projects/vietnga/BoNaoTriThuc/company-wiki/gsd-core/templates/spec.md.
