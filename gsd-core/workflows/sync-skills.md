...
INSTALL_JS_GLOBAL="D:/projects/vietnga/BoNaoTriThuc/company-wiki/gsd-core/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node D:/projects/vietnga/BoNaoTriThuc/company-wiki/gsd-core/bin/install.js --global --<runtime>
```
Then exit.
