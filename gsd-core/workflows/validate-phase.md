...
```
Agent(
  prompt="Read D:/projects/vietnga/BoNaoTriThuc/company-wiki/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `D:/projects/vietnga/BoNaoTriThuc/company-wiki/gsd-core/templates/VALIDATION.md`
