...
const capabilities = {
  ...
  "claude": {
    ...
    "version": "1.6.0",
    "title": "Cline",
    "description": "Anthropic Cline — primary development runtime; tier-1 support with full hook surface and skills-based global install.",
    "tier": "core",
    "requires": [],
    "engines": {
      "gsd": ">=1.6.0"
  ...
  "mempalace": {
    ...
    "config": {
      ...
      "mempalace.auto_capture_hooks": {
        "type": "boolean",
        "default": false,
        "description": "Reserved / not yet implemented: will install MemPalace's native stop/precompact Cline hooks for passive mid-session capture (the capability's hooks array is currently empty)."
      }
    },
    "steps": [
      {
  ...
  "profile-pipeline": {
    ...
    "description": "Developer behavioral profiling from Cline session history; scans session JSONL files, extracts and samples user messages, and generates profile artifacts (USER-PROFILE.md, dev-preferences.md, .clinerules sections). Exposes eight `gsd-tools` commands: scan-sessions, extract-messages, profile-sample (pipeline phase) and write-profile, profile-questionnaire, generate-dev-preferences, generate-claude-profile, generate-claude-md (output phase). Backs the /gsd-profile-user skill and gsd-user-profiler agent.",
    "tier": "full",
    "requires": [],
    "engines": {
      "gsd": ">=1.6.0"
    ...
    "steps": [
      {
        ...
        "fragment": {
          "path": "fragments/plan-pre.md",
          "inline": "<objective>\nResearch how to implement Phase {phase_number}: {phase_name}\nAnswer: \"What do I need to know to PLAN this phase well?\"\n</objective>\n\n<files_to_read>\n- {context_path} (USER DECISIONS from /gsd:discuss-phase)\n- {requirements_path} (Project requirements)\n- {state_path} (Project decisions and history)\n</files_to_read>\n\n${AGENT_SKILLS_RESEARCHER}\n\n<additional_context>\n**Phase description:** {phase_description}\n**Phase requirement IDs (MUST address):** {phase_req_ids}\n\n**Project instructions:** Read ./.clinerules or ./.claude/.clinerules if either exists; follow project-specific guidelines.\n**Project skills:** Check .cline/skills/ or .agents/skills/ directory if either exists. Read SKILL.md files and account for project skill patterns.\n</additional_context>\n\n<output>\nWrite to: {phase_dir}/{phase_num}-RESEARCH.md\n</output>\n"
        },
        "produces": [
          "RESEARCH.md"
        ],
