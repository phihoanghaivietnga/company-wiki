...
Reference full template: `D:/projects/vietnga/BoNaoTriThuc/company-wiki/gsd-core/templates/roadmap.md`

## STATE.md Structure

Use template from `D:/projects/vietnga/BoNaoTriThuc/company-wiki/gsd-core/templates/state.md`.
