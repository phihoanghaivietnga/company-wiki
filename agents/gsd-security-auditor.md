...
**Verification depth scales with `asvs_level`** (see @D:/projects/vietnga/BoNaoTriThuc/company-wiki/gsd-core/references/security-asvs-levels.md for full definitions):
