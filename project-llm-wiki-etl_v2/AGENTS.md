...
- **Tên project**: ETL Nano v2
- **Mô tả ngắn**: Kho tri thức về xây dựng ứng dụng ETL đồng bộ dữ liệu từ database Production sang datamart. Phục vụ xây dựng kho dữ liệu Data warehouse
